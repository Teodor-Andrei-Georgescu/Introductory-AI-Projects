...
A = BayesNode("A", '', 0.01)
S = BayesNode("S", '', 0.5)
T = BayesNode("T","A",{True:0.05, False:0.01})
L = BayesNode("L","S",{True:0.1, False:0.01})
B = BayesNode("B","S",{True:0.6, False:0.3 })
E = BayesNode("E",["L","T"],{(True, True): 1, (True, False): 1, (False, True): 1, (False, False): 0})
D = BayesNode("D",["E","B"],{(True, True): 0.9, (True, False): 0.7, (False, True): 0.8, (False, False): 0.1})
X = BayesNode("X","E",{True:0.98, False:0.05})

asia_network = BayesNet([
    ("A", '', 0.01), 
    ("S", '', 0.5), 
    ("T","A",{True:0.05, False:0.01}), 
    ("L","S",{True:0.1, False:0.01}), 
    ("B","S",{True:0.6, False:0.3 }), 
    ("E",["L","T"],{(True, True): 1, (True, False): 1, (False, True): 1, (False, False): 0}), 
...
cpt_l_true = asia_network.variable_node("L").cpt[(True,)]
cpt_l_false = asia_network.variable_node("L").cpt[(False,)]
...
ea_result = enumeration_ask("D",{'A': True, 'X': True},asia_network)
rs_result = rejection_sampling("D",dict(A=True,X=True),asia_network,100000)
lw_result = likelihood_weighting("D",dict(A=True,X=True),asia_network,100000)
